  ...
  <div class="container-lg" style="margin-top: 40px;">
    <div class="container-fluid">
      <div>
        <table>
          <tr>
            <td class="foto" rowspan="2" style="background-image: url('https://static.disqonin.com/uploads/img/12-2019/1576134386780-promo-tix-id-promo-spesial-nomat-12-12.jpg'); background-size: cover; width: 200px; height: 200px;"></td>
            <td style="height: 50px; padding-left: 20px; font-weight: bold; color: white;" class="bg-dark">Promo BCA</td>
          </tr>
          <tr>
            <td style="padding: 20px; background-color: azure; vertical-align: top;">Promo untuk semua nasabah BCA, mendapatkan tiket buy 1 get 1 untuk film tertentu
, Promo untuk semua nasabah BCA, mendapatkan tiket buy 1 get 1 untuk film tertentu
, Promo untuk semua nasabah BCA, mendapatkan tiket buy 1 get 1 untuk film tertentu</td>
          </tr>
        </table>
      </div>
    </div>
  ...
  <div class="container-lg" style="margin-top: 40px;">
    <div class="container-fluid">
      <div>
        <table>
          <tr>
            <td rowspan="2" style="background-image: url('https://static.disqonin.com/uploads/img/12-2019/1576134386780-promo-tix-id-promo-spesial-nomat-12-12.jpg'); background-size: cover; width: 200px; height: 200px;"></td>
            <td style="height: 50px; padding-left: 20px; font-weight: bold; color: white;" class="bg-dark">Promo BCA</td>
          </tr>
          <tr>
            <td style="padding: 20px; background-color: azure; vertical-align: top;">Promo untuk semua nasabah BCA, mendapatkan tiket buy 1 get 1 untuk film tertentu
